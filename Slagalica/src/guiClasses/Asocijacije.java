...
public class Asocijacije extends JFrame {
	...
	private String A1polje;
	private String A2polje;
	private String A3polje;
	private String A4polje;
	private String B1polje;
	private String B2polje;
	private String B3polje;
	private String B4polje;
	private String C1polje;
	private String C2polje;
	private String C3polje;
	private String C4polje;
	private String D1polje;
	private String D2polje;
	private String D3polje;
	private String D4polje;
	private String Apolje;
	private String Bpolje;
	private String Cpolje;
	private String Dpolje;
	private String KonacnoPolje;
	...
	public JLabel poeniLabel=new JLabel(""+poeni);
	
	JLabel usernameProtivnikLabel=new JLabel();
	public JLabel poeniProtivnikLabel=new JLabel(""+poeniProtivnik);
	...
	public Asocijacije(String username,String usernameOfPair, int scores,int scoresOfPair,PrintStream serverOutput
			, String A1polje, String A2polje, String A3polje, String A4polje, String B1polje, String B2polje,
			 String B3polje, String B4polje, String C1polje, String C2polje, String C3polje, String C4polje,
			 String D1polje, String D2polje, String D3polje, String D4polje, String Apolje, String Bpolje, String Cpolje,
			 String Dpolje, String KonacnoPolje) {
		super("Asocijacije");
		...
		this.A1polje=A1polje;
		this.A2polje=A2polje;
		this.A3polje=A3polje;
		this.A4polje=A4polje;
		this.B1polje=B1polje;
		this.B2polje=B2polje;
		this.B3polje=B3polje;
		this.B4polje=B4polje;
		this.C1polje=C1polje;
		this.C2polje=C2polje;
		this.C3polje=C3polje;
		this.C4polje=C4polje;
		this.D1polje=D1polje;
		this.D2polje=D2polje;
		this.D3polje=D3polje;
		this.D4polje=D4polje;
		this.Apolje=Apolje;
		this.Bpolje=Bpolje;
		this.Cpolje=Cpolje;
		this.Dpolje=Dpolje;
		this.KonacnoPolje=KonacnoPolje;
		this.initFrame();
	}
	...
	private void initFrame() {
		...
		usernameProtivnikLabel.setText(usernameProtivnik);
		...
		usernameLabel.setBounds(200,30,50,20);
		poeniLabel.setBounds(200,50,50,20);
		poeniLabel.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		poeniLabel.setBackground(new Color(0x004EFF));
		poeniLabel.setHorizontalAlignment(JLabel.CENTER);
		poeniLabel.setOpaque(true);
		poeniLabel.setText(""+poeni);
		
		usernameProtivnikLabel.setBounds(350,30,50,20);
		poeniProtivnikLabel.setBounds(350,50,50,20);
		poeniProtivnikLabel.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		poeniProtivnikLabel.setBackground(new Color(0xFF7276));
		poeniProtivnikLabel.setHorizontalAlignment(JLabel.CENTER);
		poeniProtivnikLabel.setOpaque(true);
		poeniProtivnikLabel.setText(""+poeniProtivnik);
		...
		this.getContentPane().add(usernameProtivnikLabel);
		this.getContentPane().add(poeniLabel);
		this.getContentPane().add(poeniProtivnikLabel);
		...
		AKonacno.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==AKonacno) {
					...
					if(resenjeA.equals(Apolje.toLowerCase())) {
						aKonacnoUpdate();
		...
		BKonacno.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==BKonacno) {
					...
					if(resenjeB.equals(Bpolje.toLowerCase())) {
						bKonacnoUpdate();
						if(KonacnoResenje.isEditable()==false) {
							KonacnoResenje.setEditable(true);
						}
		...
		CKonacno.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==CKonacno) {
					...
					if(resenjeC.equals(Cpolje.toLowerCase())) {
						cKonacnoUpdate();
						if(KonacnoResenje.isEditable()==false) {
							KonacnoResenje.setEditable(true);
						}
		...
		DKonacno.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==DKonacno) {
					...
					if(resenjeD.equals(Dpolje.toLowerCase())) {
						dKonacnoUpdate();
						if(KonacnoResenje.isEditable()==false) {
							KonacnoResenje.setEditable(true);
						}
		...
		KonacnoResenje.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==KonacnoResenje) {
					...
					if(konacnoResenje.equals(KonacnoPolje.toLowerCase())) {
						KonacnoResenje.setText(KonacnoPolje);
						KonacnoResenje.setEditable(false);
