...
public class Asocijacije extends JFrame {
	...
	Timer t=new Timer();
	TimerTask task;
	JLabel KoJeNaPotezu=new JLabel("Vi ste na potezu");
	...
	JLabel poeniPrviIgrac=new JLabel("Poeni");
	JLabel brojPoenaPrvi=new JLabel(""+poeni);
	
	JLabel poeniDrugiIgrac=new JLabel("Poeni");
	JLabel brojPoeniDrugi=new JLabel(""+poeni);
	...
	private void initFrame() {
		...
		task=new TimerTask() {
			...
			public void run() {
				...
				tajmerLabel.setText("");
				client.posaljiServeru("ZavršenaPartija");	
				client.posaljiServeru("KonacnoUpdate");	
				t.cancel();
			}	
		};
		...
		Dalje.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Dalje.setEnabled(false);
				client.posaljiServeru("završenTurn");
			}
		});
		...
		A1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==A1) {
					...
					client.posaljiServeru("A1Kliknut");
		...
		A2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==A2) {
					...
					client.posaljiServeru("A2Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		A3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==A3) {
					...
					client.posaljiServeru("A3Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		A4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==A4) {
					...
					client.posaljiServeru("A4Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==AKonacno) {
					...
					if(resenjeA.equals("dinar")) {
						...
						updatePoeni();
						AKonacno.setEditable(false);
						client.posaljiServeru("AKonacnoUpdate");
					}else {
						AKonacno.setText("A");
						//isteko je turn
						client.posaljiServeru("završenTurn");
		...
		B1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==B1) {
					...
					client.posaljiServeru("B1Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		B2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==B2) {
					...
					client.posaljiServeru("B2Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		B3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==B3) {
					...
					client.posaljiServeru("B3Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		B4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==B4) {
					...
					client.posaljiServeru("B4Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==BKonacno) {
					...
					if(resenjeB.equals("rastanak")) {
						...
						updatePoeni();
						BKonacno.setEditable(false);
						client.posaljiServeru("BKonacnoUpdate");
					}else {
						BKonacno.setText("B");
						client.posaljiServeru("završenTurn");
						ugasiDalje();
		...
		C1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==C1) {
					...
					client.posaljiServeru("C1Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		C2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==C2) {
					...
					client.posaljiServeru("C2Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		C3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==C3) {
					...
					client.posaljiServeru("C3Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		C4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==C4) {
					...
					client.posaljiServeru("C4Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==CKonacno) {
					...
					if(resenjeC.equals("buna")) {
						...
						updatePoeni();
						CKonacno.setEditable(false);
						client.posaljiServeru("CKonacnoUpdate");
					}else {
						CKonacno.setText("C");
						client.posaljiServeru("završenTurn");
						ugasiDalje();
		...
		D1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==D1) {
					...
					client.posaljiServeru("D1Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		D2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==D2) {
					...
					client.posaljiServeru("D2Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
		...
		D3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==D3) {
					...
					client.posaljiServeru("D3Kliknut");
					onemogucitiSvaOstalaPolja();
					Dalje.setEnabled(true);
				}
			}
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==DKonacno) {
					...
					if(resenjeD.equals("dom")) {
						...
						if(D4Kliknut==false) {
							d4update();
							client.posaljiServeru("D4Kliknut");
						}
						poeni+=10;
						updatePoeni();
						DKonacno.setEditable(false);
						client.posaljiServeru("DKonacnoUpdate");
					}else {
						DKonacno.setText("D");
						client.posaljiServeru("završenTurn");
						ugasiDalje();
	...
	public void zavrsenapartija() {
	 ...
	 public void updatePoeni() {
		 client.posaljiServeru("updatePoeni");
		 client.posaljiServeru(""+poeni);
	 }
